...
namespace net_plumber {
  ...
  class NetPlumber {
...
#ifdef USE_GROUPS
    uint64_t _add_rule(const uint32_t table, const uint32_t index, bool group, uint64_t gid,
                       List_t in_ports, List_t out_ports,
                       T2 *match, T2 *mask, T2 *rw);
#else
    uint64_t _add_rule(const uint32_t table, const uint32_t index,
                       List_t in_ports, List_t out_ports,
                       T2 *match, T2 *mask, T2 *rw);
#endif
   ...
   public:
     ...
     */
    uint64_t add_rule(const uint32_t table, const uint32_t index, List_t in_ports, List_t out_ports,
                  T2 *match, T2 *mask, T2 *rw);
#ifdef USE_GROUPS
    uint64_t add_rule_to_group(const uint32_t table, const uint32_t index, List_t in_ports,
