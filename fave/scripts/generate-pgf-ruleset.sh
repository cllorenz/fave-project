...
echo "ip6tables -A INPUT -s 2001:db8:abc::8 -p tcp --dport 22 -j ACCEPT" >> $SCRIPT
...
private 2001:db8:abc:1::1 tcp:22
...
private 2001:db8:abc:1::2 tcp:22
#public 2001:db8:abc:1::2 \
...
private 2001:db8:abc:1::5 tcp:22
...
private 2001:db8:abc:1::6 tcp:22
#private 2001:db8:abc:1::6 tcp:22,udp:22

private 2001:db8:abc:1::7 tcp:118,tcp:156,tcp:22
#private 2001:db8:abc:1::7 tcp:118,tcp:156,tcp:22,udp:118,udp:156,udp:22

private 2001:db8:abc:1::8 tcp:161,tcp:22
...
#    private_sub $cnt $PREFIX::2 tcp:22,udp:22
    ...
    # print
    private_sub $cnt $PREFIX::3 tcp:631,tcp:22
#    private_sub $cnt $PREFIX::3 tcp:631,tcp:22,udp:631,udp:22
    ...
    public $PREFIX::4 \
      tcp:25,tcp:587,tcp:110,tcp:143,tcp:220,tcp:465,tcp:993,tcp:995
#      tcp:25,tcp:587,tcp:110,tcp:143,tcp:220,tcp:465,tcp:993,tcp:995,udp:143,udp:220
    private_sub $cnt $PREFIX::4 tcp:22
