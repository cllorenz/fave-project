...
UP = {
    ...
    'dmz' : [
        ("file.uni-potsdam.de", "2001:db8:abc:0::1", ["tcp:21", "tcp:115", "tcp:22", "udp:22"]),
        ("mail.uni-potsdam.de", "2001:db8:abc:0::2", [
