...
matches NetPlumber **exactly** (0 diffs, **3661/3661** pairs). The
...
- **Re-measure the *timing* headlines on the pinned env before freezing.** Correctness
  numbers (3661/3661, exactness gate) are deterministic and safe as-is. But the build-time
...
|---|---|---|
| wl_up (IPv6 5-tuple) | exact 3661/3661 vs frozen BDD golden | **~0.5 s vs BDD ~1079 s** (~2000×) |
