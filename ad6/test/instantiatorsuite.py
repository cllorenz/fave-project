...
class InstantiatorSuite(TestSuite):
    def addTests(self):
        tests = [
            ...
            'testNegatedFieldMatchExcludesItsValue',
            'testNegatedFieldMatchesOnOneFieldConjoin',
            'testMixedFieldMatchPolaritiesOnOneField',
            'testMaskedFieldMatchConstrainsOnlyItsDeterminedBits',
            'testMaskedFieldMatchDontCaresAreGenuinelyFree',
            'testWhollyUnconstrainedFieldMatchIsVacuouslyTrue',
            'testNegatedMaskedFieldMatchExcludesTheWholeRange',
            'testAMaskedRewriteFREESTheBitsItDoesNotDetermine',
            'testAnAllDontCareRewriteIsExactlyAClear',
            'testAnUnmaskedRewriteStillOverwritesEverything',
