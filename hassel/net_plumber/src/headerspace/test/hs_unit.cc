...
void HeaderspaceTest::test_comp_diff_regression() {
    ...
    struct hs a = {18, {0, 0, 0, 0}};

    //                                     sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=0.0.0.0/0
    hs_vec_append(&a.list, array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,xxxxxxxx,xxxxxxxx,xxxxxxxx,xxxxxxxx"), false);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=123.123.123.0/24
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,01111011,01111011,00110000,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.12.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0000110x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.16.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001000x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.18.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001001x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.20.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001010x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.22.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001011x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.24.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001100x,xxxxxxxx"), true);

    //                                             sip=10.0.14.0/23,                   in=0x5000b,                         vlan=4095,        out=0x2002b,                        dip=10.0.30.0/23
    hs_vec_append(&a.list.diff[0], array_from_str("00001010,00000000,0000111x,xxxxxxxx,00000000,00000101,00000000,00001011,00001111,11111111,00000000,00000010,00000000,00101011,00001010,00000000,0001111x,xxxxxxxx"), true);
