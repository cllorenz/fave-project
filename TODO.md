...
- [ ] **Step 0 (FIRST, independent)** — the §8 NDD VLAN-slot fix. The only thing in this package that is **wrong today**; two lines mirroring the `+ acl` branch plus a differential test. Jumps the queue because it is a defect, not a guardrail.
