...
- [ ] The VLAN *rewrite* residue (22 rules) needs **no new primitive**: `+ nat <dev> <port> vlan ...` exists and the faithful path uses it; it is simply not wired into `_build_first_match_tables`.
